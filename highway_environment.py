...
class CustomHighwayEnv(HighwayEnv):
    def __init__(self, *args, **kwargs):
        self.vehicles_count = config_highway.vehicles_count
        self.initial_min_speed = config_highway.initial_min_speed
        self.initial_max_speed = config_highway.initial_max_speed
        self.min_speed = config_highway.min_speed
        self.max_speed = config_highway.max_speed
