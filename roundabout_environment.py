...
class CustomRoundaboutEnv(RoundaboutEnv):
    def __init__(self, *args, **kwargs):
        self.vehicles_count = config_roundabout.vehicles_count
        self.initial_min_speed = config_roundabout.initial_min_speed
        self.initial_max_speed = config_roundabout.initial_max_speed
        self.min_speed = config_roundabout.min_speed
        self.max_speed = config_roundabout.max_speed
