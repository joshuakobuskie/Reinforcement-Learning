...
# model = DQN("MlpPolicy", env, policy_kwargs=policy_kwargs, learning_rate=config_roundabout.learning_rate, buffer_size=config_roundabout.buffer_size, learning_starts=config_roundabout.learning_starts, batch_size=config_roundabout.batch_size, gamma=config_roundabout.gamma, train_freq=config_roundabout.train_frequency, exploration_fraction=config_roundabout.exploration_fraction, target_update_interval=config_roundabout.target_update_interval)
